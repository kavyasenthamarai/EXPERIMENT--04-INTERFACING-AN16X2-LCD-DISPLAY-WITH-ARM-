...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
   ...
   Lcd_cursor(&lcd, 0,0);
   Lcd_string(&lcd," 212222230065");
   Lcd_cursor(&lcd, 1,0);
   Lcd_string(&lcd,"Kavya.k");
  /* USER CODE END 2 */
...
/**
  ...
  * @retval None
  */
void ass/* USER CODE BEGIN Header */
/**
  ******************************************************************************
  * @file           : main.c
...
void Error_Handler(void)
{
  ...
  /* USER CODE END Error_Handler_Debug */
}ert_failed(uint8_t *file, uint32_t line)
{
  /* USER CODE BEGIN 6 */
...
## Output screen shots of proteus  :
 ![WhatsApp Image 2023-05-11 at 15 47 38](https://github.com/kavyasenthamarai/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/118668727/3477af81-fdf7-43f3-80d6-654cd3ab3231)

 

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![WhatsApp Image 2023-05-11 at 15 48 03](https://github.com/kavyasenthamarai/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/118668727/de583158-4ab3-476c-a2ae-d5edb0e8e01d)
